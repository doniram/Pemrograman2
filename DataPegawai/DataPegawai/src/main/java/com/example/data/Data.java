...
public class Data {
    ...
    Data(Long nip, String nama, String alamat, String jabatan, String divisi, String pot_pajak, Long gaji) {
        this.nip = nip;
        this.nama = nama;
        this.alamat = alamat;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, data.id) && Objects.equals(this.nip, data.nip)
                ...
                && Objects.equals(this.divisi, data.divisi) 
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this.id, this.nip, this.nama, this.alamat, this.jabatan, this.divisi, this.pot_pajak, this.gaji);
    }

    @Override
    public String toString() {
        return "Data pegawai{" + "id=" + this.id + ", NIP='" + this.nip + '\'' + ", nama='" + this.nama + '\''
                + ", alamat='" + this.alamat + '\'' + ", jabatan='" + this.jabatan + '\'' + ", divisi='" + this.divisi + '\'' + ", pot_pajak='"
